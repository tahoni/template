...
2. **What was added**, as a fenced `markdown` diff-style list of the new bullets (or "Nothing to add —
   `### 🧪 [Unreleased]` already covers every notable change on this branch.").
